<div id="product-form-container" style="display: none;">
    <style>
        ...
        .modal-header { margin-bottom: 20px; flex-shrink: 0; }
        ...
        .info-section { display: flex; flex-direction: column; height: 100%; }
        ...
        <div class="modal-content">
            ...
            <form id="product-form" enctype="multipart/form-data" style="display: contents;">
                    ...
                    <div class="modal-body-layout">
                        ...
                        <div class="upload-section">
                                ...
                                @for($i = 0; $i < 4; $i++)
                                    <div class="upload-zone" id="zone-img-{{$i}}" onclick="if(!this.classList.contains('has-file')) document.getElementById('file-img-{{$i}}').click()">
                                        ...
                                        <div class="plus-icon" style="color:#aaa; text-align:center;">
                                            <i class="fas fa-camera"></i><span style="display:block; font-size:10px;">Tải ảnh</span>
                                        </div>
                            ...
                            <div class="upload-zone model-zone" id="zone-model" onclick="if(!this.classList.contains('has-file')) document.getElementById('file-model').click()">
                                ...
                                <model-viewer id="prev-model" auto-rotate camera-controls style="display:none; width: 100%; height: 100%; background-color: #eee; position: absolute; top:0; left:0;"></model-viewer>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer-left">
                    <button class="btn btn--e-brand-b-2" type="button" id="submit-form-btn-modal" style="height: 45px; padding: 0 30px;">LƯU THÔNG TIN</button>
                    <button class="btn btn--e-dark-outline" type="button" onclick="hideForm()" style="height: 45px; padding: 0 30px;">HỦY BỎ</button>
                </div>
            </form>
        </div>
    </div>
